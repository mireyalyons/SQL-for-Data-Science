...
--This question is for you to practice executing queries. I have provided you the script for this query, a simple select statement. 
--Think of this as a sandbox for you to practice. As you practice executing queries, take time to read the results in order to prepare for the quiz and get comfortable writing a basic select statement. 
...
--18 and number 5, 90's Music.


--5. Run Query: Return the Customer Id, Invoice Date, and Billing City from the Invoices table. What city is associated with Customer ID number 42? 
...
--This particular query provided 2 columns, one with playlist ID and one with track ID. 
--By knowing your dataset, you will be able to determine how or when this particular information might be useful. 
...
--3 columns and Plays Metallica By Four Cellos
