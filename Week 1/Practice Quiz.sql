...
--2. In the ER diagram below, the infinity symbol is representing a "many" relationship and the key is representing "one". 
--Select all the tables that have a one-to-many relationship.
